...
-- 1. The crime scene at Coral Bay Marina on August 14, 1986
--    revealed two witnesses nearby -- one on 300-range Ocean
--    Drive and another with a name ending in "ul" + "ez".
-- 2. Carlos Mendez (369 Ocean Drive) reported seeing a nervous
--    man check into a hotel on August 13, the night before.
-- 3. Querying hotel check-ins for August 13 and joining
--    surveillance records identified Robert Smith checking into
--    the Sunset Marina Hotel under the alias "Red Rob."
-- 4. Surveillance noted he was seen arguing with an unknown
--    person -- consistent with a confrontation before the murder.
-- 5. His confession places him at the scene the night before
